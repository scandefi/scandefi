...
Route::group(['prefix' => 'api'], function () {
    ...
    Route::post('wallet/following/create', 'WalletFollowingController@create');
    Route::get('wallet/following/read/{id}', 'WalletFollowingController@read');
    Route::put('wallet/following/update/{id}', 'WalletFollowingController@update');
    Route::delete('wallet/following/delete/{id}', 'WalletFollowingController@delete');
...
Route::post('reports/{report}/comment', 'ReportController@comment');
// });
